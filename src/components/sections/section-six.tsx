...
function SectionSix() {
  ...
  return (
    <section id="faqs" className="bg-[#1F2933] w-full py-15 overflow-hidden">
      <div className="max-w-360 w-[90%] mx-auto flex flex-col xl:flex-row xl:items-center gap-y-12">
